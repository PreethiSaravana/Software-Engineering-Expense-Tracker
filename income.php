                                        ...
                                        <div class='row'>
                                            <div class='col-md-12'>
                                                <div class='form-group'>
													...
													<a href="http://localhost/software/owninc.php" class="btn btn-primary">Add own category</a>
...
$query = "select * from income where amount!=0";
...
if (isset($_POST['submit'])) {
 ...
 $insert_query = "insert into income ( date,categories,amount,type) values ('$date','$categories','$amount','$type')";
