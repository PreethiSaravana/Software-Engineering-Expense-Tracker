										...
										<div class='row'>
									        <div class='col-md-6'>
                                                <div class='form-group'>
													...
													<input class="form-control" id="username" name="due_date"  type="date" />
                                                </div>
                                            </div>  
                                        </div>
                                        <div class='row'>
...
if (isset($_POST['submit'])) {
 ...
 $insert_query = "insert into borrow ( name,amount,date,due_date) values ('$name','$amount','$date','$due_date')";
if (mysqli_query($connect,$insert_query)) {
      ...
      echo "<script>window.open('borrow.php','_self')</script>";
 ...
 $delete_query = "delete from borrow where name='$name' and amount='$amount' and date='$date' and due_date='$due_date' ";
