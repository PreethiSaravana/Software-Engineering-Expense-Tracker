                    ...
                    <ul class="sidebar-menu">
                      ...
                      <li class="treeview ">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="income.php">Add Bus</a></li>
                                <li><a href="income.php">Update Bus</a></li>
                            </ul>
                        </li>
						
						 <li class="treeview"><a href="income.php"><i class="fa fa-user"></i> <span>Profile</span></a>
                        </li>
						<li class="treeview"><a href="income.php"><i class="fa fa-power-off"></i> <span>Logout</span></a>
                        </li>
...
$query = "select date,categories,sum(amount) from income order by date,categories";
...
while ($row=mysqli_fetch_array($run)) {
    ...
    ?> 
            ...
            <footer class="main-footer">
                <!-- Default to the left -->
                <strong>Copyright &copy; 2018 <a href="index.php">Voice Based Transport Enquiry system</a>.</strong> All rights reserved.
                <!-- To the right -->
