										 ...
										 <div class='row'>
									        <div class='col-md-6'>
                                                <div class='form-group'>
                                                    ...
                                                    <input class="form-control" id="username" name="type"  type="text" />
                                                </div>
                                            </div>  
                                        </div>-->
...
if (isset($_POST['submit'])) {
	...
	//$date=$_POST['date'];
	$categories=$_POST['month'];
	//$amount=$_POST['amount'];
	//$type=$_POST['type'];
	

 $insert_query = "update balance set totinc=(select sum(amount) from income where month(date)='$categories') where month='$categories'";
 $insert_query2 = "update balance set totexp=(select sum(amount) from exp1 where month(date)='$categories') where month='$categories'";
$insert_query3 = "update balance set bal=(totinc-totexp) where month='$categories'";



     
      if (mysqli_query($connect,$insert_query)&&(mysqli_query($connect,$insert_query2))&&(mysqli_query($connect,$insert_query3))){
